...
// Enable Search Button when Model is Selected
...
searchButton.addEventListener("click", function () {
    ...
    if (selectedBrand && selectedModel) {
        ...
        resultDiv.innerHTML = `
            <h2>${selectedBrand.toUpperCase()} - ${selectedModel.toUpperCase()}</h2>
            <p><strong>Processor:</strong> ${modelData.processor}</p>
            <p><strong>RAM:</strong> ${modelData.memory.ram}GB</p>
            <p><strong>Storage:</strong> ${modelData.memory.storage}GB</p>
            <p><strong>Battery:</strong> ${modelData.battery}mAh</p>
            <p><strong>Operating System:</strong> ${modelData.operatingSystem}</p>
            <p><strong>Special Features:</strong> ${modelData.specialFeatures.join(", ")}</p>
        `;
